...
export const ComunidadScreen = () => {
  ...
  const handleCreate = async (e: Event) => {
    ...
    if (room) {
      ...
      setNewRoomName("");
      setNewRoomDesc("");
      navigate(`/familia/comunidad/${room.id}`, { state: { roomName: room.name } });
    }
  };
          ...
          >
            ...
            <form onSubmit={handleCreate} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <input
                ...
                autoFocus
                style={{
                  padding: "12px 14px", borderRadius: 12, border: `1px solid ${colors.gray300}`,
                  fontSize: 13, fontFamily: fonts.body, color: colors.text, outline: "none",
                }}
              />
              <input
              ...
              <div style={{ display: "flex", gap: 10 }}>
                <button
                  ...
                  onClick={() => setShowCreate(false)}
                  style={{
                    flex: 1, padding: "12px 0", background: colors.gray100, border: "none",
                    borderRadius: 12, fontSize: 13, fontWeight: 700, cursor: "pointer",
                    fontFamily: fonts.body, color: colors.textLight,
                  }}
                >
                  Cancelar
                </button>
                <button
                  ...
                  style={{
                    ...
                    background: creating || !newRoomName.trim() ? colors.gray300 : colors.blue,
        ...
        <div style={{ background: colors.blue, padding: "16px 20px", color: "white", flexShrink: 0 }}>
          ...
          <div
            style={{
              ...
              borderRadius: 20, padding: 3, marginTop: 12, gap: 2,
            }}
          >
          ...
          <>
            ...
            <div style={{ flex: 1, overflowY: "auto", background: "white", paddingBottom: 80 }}>
              ...
              {rooms.map((room) => (
                <div
                  key={room.id}
                  onClick={() => navigate(`/familia/comunidad/${room.id}`, { state: { roomName: room.name } })}
                  style={{
